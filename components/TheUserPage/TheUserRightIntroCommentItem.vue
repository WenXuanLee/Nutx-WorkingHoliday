<template>
	<div>
	  <div class="row text-center-sm" id="review-287970581">
	    <div class="col-md-2 col-sm-12">
	      ...
	      :anchor-url="userLink"
				...
				:comment-date="commentDate"></wt-avatar>
	    </div>
	    <div class="col-md-10 col-sm-12">
	      <div class="space-2">
	        ...
	        <span class="text-muted date hide-sm wt-float-left">
	          <span>
	            來自<a href="/s/美國" class="link-reset">{{ userLocation}}</a> ·
	            {{ commentDate }}
	            &nbsp;·&nbsp;
	          </span>
	          <span class="review-flag" data-review-flag-id="287970581">
	            <button type="button" class="report-flag" aria-busy="false" style="padding: 0px; margin: 0px;">
	              <svg viewBox="0 0 24 24" role="img" aria-label="檢舉此評價" focusable="false" style="height: 1em; width: 1em; display: block; fill: rgb(118, 118, 118);">
...
<script>
	import wtAvatar from '@/components/wt-avatar.vue'
	export default {
		props: {
			userName: {
				type: String,
...
.expandable.expanded .expandable-content, .expandable.expanded .expandable-content-long, .react-expandable.expanded .expandable-content, .react-expandable.expanded .expandable-content-long {
    height: auto;
}
