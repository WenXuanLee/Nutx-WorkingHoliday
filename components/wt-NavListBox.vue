...
<script>
	import wtNavListBoxItem from '@/components/wt-NavListBoxItem.vue'
	export default {
		props: {
			listBoxItem: {
				type: Array,
...
<style lang="less" scoped>
	...
	.dropdown-block {
	  ...
	  border-color: rgb(219, 219, 219) rgb(219, 219, 219) rgb(219, 219, 219) !important;
